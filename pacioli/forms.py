...
EntriesFormSet = modelformset_factory(
    models.Entries, fields=["transaction", "account", "credit", "amount"], min_num=5
)
TransactionEntriesFormSet = inlineformset_factory(
    models.Transactions,
    models.Entries,
    fields=["id", "transaction", "account", "credit", "amount"],
)
